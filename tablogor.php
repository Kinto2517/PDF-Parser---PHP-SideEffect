...
<section  class="flex flex-col justify-center antialiased bg-gray-100 text-gray-600 min-h-screen p-4" style="background-image: url(https://images.hdqwalls.com/wallpapers/gradient-blur-minimalism-fh.jpg)">
    <div class="h-full">
        <div class="w-full max-w-2xl mx-auto bg-white shadow-lg rounded-sm  border-gray-200" style="width: 1600px">
                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-full ">
                        ...
                        <tr>
                            ...
                            <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-left">Ogr Ad</div>
                            </th>
                            <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-left">Ogr No</div>
                            </th>
                            <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-center">Ogr Turu</div>
                            </th>
                            <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-left">Baslik</div>
                            </th>
                            <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-left">Tarih</div>
                            </th>
                            <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-center">Danisman</div>
                            </th>  <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-left">Juri1</div>
                            </th>
                            <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-left">Juri2</div>
                            </th>
                            <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-center">Ders</div>
                            </th>
                            <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-center">Anahtar</div>
                        ...
                        while($row = mysqli_fetch_array($result2)) {  ?>
                            ...
                            <tr>
                                ...
                                <td class="p-2 whitespace-nowrap"><?php echo $row['ogrAd']; ?></td>
                                <td class="p-2 whitespace-nowrap"><?php echo $row['ogrNo']; ?></td>
                                <td class="p-2 whitespace-nowrap"><?php echo $row['ogrTuru']; ?></td>
                                <td class="p-2 whitespace-nowrap"><?php echo $row['baslik']; ?></td>
                                <td class="p-2 whitespace-nowrap"><?php echo $row['tarih']; ?></td>
                                <td class="p-2 whitespace-nowrap"><?php echo $row['danisman']; ?></td>
                                <td class="p-2 whitespace-nowrap"><?php echo $row['juri1']; ?></td>
                                <td class="p-2 whitespace-nowrap"><?php echo $row['juri2']; ?></td>
                                <td class="p-2 whitespace-nowrap"><?php echo $row['ders']; ?></td>
                                <td class="p-2 whitespace-nowrap"><?php echo $row['anahtar']; ?></td>
