                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-full">
                        ...
                        <tr>
                            ...
                            <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-left">Kullanıcı Adı</div>
                            </th>
                            <th class="p-2 whitespace-nowrap">
                        ...
                        $row1 = mysqli_fetch_array($result1);
                            ...
                            while($row = mysqli_fetch_array($result)) {?>
                                ...
                                <td class="p-2 whitespace-nowrap"><?php echo $row['dosyaadi']; ?></td>
                                    <td class="p-2 whitespace-nowrap"><?php echo $row['kullanicigiris']; ?></td>
                                    <td class="p-2 whitespace-nowrap"><a href="uploads/<?php echo $row['dosyaadi']; ?>" target="_blank">İncele</a></td>
                                <td><a href="uploads/<?php echo $row['dosyaadi']; ?>" download>İndir</a></td>
                            </tr>
                        <?php }?>
                        </tbody>
                    </table>
