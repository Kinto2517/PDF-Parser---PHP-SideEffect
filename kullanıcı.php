...
echo '<div style="font-size:1.25em;color:#a20030;font-weight:bold;"><span style="font-size:2em;color:#91686c;font-weight:bold;margin-left: 600px">' .$_SESSION['yenioturum'].'</span></div>';
...
<nav >
    ...
    <a href="yukleSayfa.php" class="mm1" target="_blank">Dosya Ekle</a>
    <a href="pdfGoster.php" class="mm1" target="_blank">Dosyalarım</a>
